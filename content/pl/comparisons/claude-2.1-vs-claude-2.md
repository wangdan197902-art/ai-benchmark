...
| Benchmark | Claude 2.1 | Claude 2 | Zwycięzca |
|------|------|------|--------|
| ARC | 84.8 | 80.4 | A |
...
- [Claude 2.1 Dokumentacja](https://docs.anthropic.com/claude/docs)
- [Claude 2 Dokumentacja](https://docs.anthropic.com/claude/docs)
