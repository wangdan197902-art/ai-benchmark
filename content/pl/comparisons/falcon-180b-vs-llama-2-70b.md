...
# Falcon 180B kontra Llama 2 70B
...
| Benchmark | Falcon 180B | Llama 2 70B | Zwycięzca |
|------|------|------|--------|
| ARC | 91.6 | 80.3 | A |
...
- [Falcon 180B Dokumentacja](https://huggingface.co/models)
- [Llama 2 70B Dokumentacja](https://llama.meta.com/docs/)
