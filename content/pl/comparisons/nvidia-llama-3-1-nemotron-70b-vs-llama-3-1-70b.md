...
# NVIDIA Llama 3.1 Nemotron 70B kontra Llama 3.1 70B
...
| Benchmark | NVIDIA Llama 3.1 Nemotron 70B | Llama 3.1 70B | Zwycięzca |
|------|------|------|--------|
| ARC | 93.2 | 92.3 | A |
...
- [NVIDIA Llama 3.1 Nemotron 70B Dokumentacja](https://huggingface.co/models)
- [Llama 3.1 70B Dokumentacja](https://llama.meta.com/docs/)
