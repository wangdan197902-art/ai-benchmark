...
# Gemini 1.5 Pro kontra Gemini 2.0 Flash
...
| Benchmark | Gemini 1.5 Pro | Gemini 2.0 Flash | Zwycięzca |
|------|------|------|--------|
| ARC | — | 95.7 | B |
...
- [Gemini 2.0 Flash Dokumentacja](https://ai.google.dev/gemini-api/docs)
