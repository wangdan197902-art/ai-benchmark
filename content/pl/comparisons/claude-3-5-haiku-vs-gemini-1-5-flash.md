...
# Claude 3.5 Haiku kontra Gemini 1.5 Flash
...
| Benchmark | Claude 3.5 Haiku | Gemini 1.5 Flash | Zwycięzca |
|------|------|------|--------|
| ARC | 91.8 | 93.4 | B |
...
- [Gemini 1.5 Flash Dokumentacja](https://ai.google.dev/gemini-api/docs)
