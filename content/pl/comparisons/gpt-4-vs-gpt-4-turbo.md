...
| Benchmark | GPT-4 | GPT-4 Turbo | Zwycięzca |
|------|------|------|--------|
| ARC | 94.1 | 94.2 | Tie |
...
- [GPT-4 Dokumentacja](https://platform.openai.com/docs/models)
- [GPT-4 Turbo Dokumentacja](https://platform.openai.com/docs/models)
