...
| בנצ'מרק | Phi-3 Medium | Phi-3 Small | זוכה |
|------|------|------|--------|
| ARC | 90.1 | 89.6 | A |
...
- [Phi-3 Medium תיעוד](https://huggingface.co/models)
- [Phi-3 Small תיעוד](https://huggingface.co/models)
