...
| בנצ'מרק | GPT-3.5 Turbo | GPT-4 | זוכה |
|------|------|------|--------|
| ARC | 86.8 | 94.1 | B |
...
- [GPT-3.5 Turbo תיעוד](https://platform.openai.com/docs/models)
- [GPT-4 תיעוד](https://platform.openai.com/docs/models)
