...
# Claude 3.5 Sonnet נגד Claude 3 Opus
...
| בנצ'מרק | Claude 3.5 Sonnet | Claude 3 Opus | זוכה |
|------|------|------|--------|
| ARC | — | 94.5 | B |
...
- [Claude 3.5 Sonnet תיעוד](https://docs.anthropic.com/claude/docs)
- [Claude 3 Opus תיעוד](https://docs.anthropic.com/claude/docs)
