...
# Qwen2.5 32B tegen Mistral Small 3
...
| Benchmark | Qwen2.5 32B | Mistral Small 3 | Winnaar |
|------|------|------|--------|
| ARC | 93.9 | 91.8 | A |
...
- [Qwen2.5 32B Documentatie](https://qwenlm.github.io/)
- [Mistral Small 3 Documentatie](https://docs.mistral.ai/)
