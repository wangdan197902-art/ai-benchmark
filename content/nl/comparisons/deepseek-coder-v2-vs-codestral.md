...
# DeepSeek Coder V2 tegen Codestral
...
| Benchmark | DeepSeek Coder V2 | Codestral | Winnaar |
|------|------|------|--------|
| ARC | 88.5 | 87.4 | A |
...
- [DeepSeek Coder V2 Documentatie](https://api-docs.deepseek.com/)
- [Codestral Documentatie](https://docs.mistral.ai/)
