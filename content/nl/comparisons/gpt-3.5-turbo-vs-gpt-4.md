...
| Benchmark | GPT-3.5 Turbo | GPT-4 | Winnaar |
|------|------|------|--------|
| ARC | 86.8 | 94.1 | B |
...
- [GPT-3.5 Turbo Documentatie](https://platform.openai.com/docs/models)
- [GPT-4 Documentatie](https://platform.openai.com/docs/models)
