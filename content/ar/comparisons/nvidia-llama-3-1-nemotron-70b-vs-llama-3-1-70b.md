...
# NVIDIA Llama 3.1 Nemotron 70B ضد Llama 3.1 70B
...
| المعيار | NVIDIA Llama 3.1 Nemotron 70B | Llama 3.1 70B | الفائز |
|------|------|------|--------|
| ARC | 93.2 | 92.3 | A |
...
- [NVIDIA Llama 3.1 Nemotron 70B الوثائق](https://huggingface.co/models)
