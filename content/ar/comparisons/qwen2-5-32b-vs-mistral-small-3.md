...
# Qwen2.5 32B ضد Mistral Small 3
...
| المعيار | Qwen2.5 32B | Mistral Small 3 | الفائز |
|------|------|------|--------|
| ARC | 93.9 | 91.8 | A |
...
- [Qwen2.5 32B الوثائق](https://qwenlm.github.io/)
- [Mistral Small 3 الوثائق](https://docs.mistral.ai/)
