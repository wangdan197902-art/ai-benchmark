...
| المعيار | Command R | Command R+ | الفائز |
|------|------|------|--------|
| ARC | 93.9 | — | A |
...
- [Command R الوثائق](https://docs.cohere.com/docs)
- [Command R+ الوثائق](https://docs.cohere.com/docs/command-r-plus)
