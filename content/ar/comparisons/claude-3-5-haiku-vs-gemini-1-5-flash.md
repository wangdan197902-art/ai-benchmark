...
# Claude 3.5 Haiku ضد Gemini 1.5 Flash
...
| المعيار | Claude 3.5 Haiku | Gemini 1.5 Flash | الفائز |
|------|------|------|--------|
| ARC | 91.8 | 93.4 | B |
...
- [Claude 3.5 Haiku الوثائق](https://docs.anthropic.com/claude/docs)
- [Gemini 1.5 Flash الوثائق](https://ai.google.dev/gemini-api/docs)
