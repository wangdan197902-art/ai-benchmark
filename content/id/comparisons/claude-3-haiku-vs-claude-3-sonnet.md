...
| Benchmark | Claude 3 Haiku | Claude 3 Sonnet | Pemenang |
|------|------|------|--------|
| ARC | 94.3 | 94.8 | B |
...
- [Claude 3 Haiku Dokumentasi](https://docs.anthropic.com/claude/docs)
- [Claude 3 Sonnet Dokumentasi](https://docs.anthropic.com/claude/docs)
