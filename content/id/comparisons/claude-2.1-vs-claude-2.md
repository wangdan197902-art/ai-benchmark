...
| Benchmark | Claude 2.1 | Claude 2 | Pemenang |
|------|------|------|--------|
| ARC | 84.8 | 80.4 | A |
...
- [Claude 2.1 Dokumentasi](https://docs.anthropic.com/claude/docs)
- [Claude 2 Dokumentasi](https://docs.anthropic.com/claude/docs)
