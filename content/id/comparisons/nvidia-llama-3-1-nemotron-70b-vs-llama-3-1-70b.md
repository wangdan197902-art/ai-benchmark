...
# NVIDIA Llama 3.1 Nemotron 70B vs Llama 3.1 70B
...
| Benchmark | NVIDIA Llama 3.1 Nemotron 70B | Llama 3.1 70B | Pemenang |
|------|------|------|--------|
| ARC | 93.2 | 92.3 | A |
...
- [NVIDIA Llama 3.1 Nemotron 70B Dokumentasi](https://huggingface.co/models)
