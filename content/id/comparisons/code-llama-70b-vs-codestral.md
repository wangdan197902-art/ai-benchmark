...
| Benchmark | Code Llama 70B | Codestral | Pemenang |
|------|------|------|--------|
| ARC | 89.8 | 87.4 | A |
...
- [Code Llama 70B Dokumentasi](https://llama.meta.com/docs/)
- [Codestral Dokumentasi](https://docs.mistral.ai/)
