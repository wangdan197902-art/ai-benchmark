...
| Benchmark | DeepSeek Coder 33B | Code Llama 34B | Pemenang |
|------|------|------|--------|
| ARC | 92.2 | 88.7 | A |
...
- [DeepSeek Coder 33B Dokumentasi](https://api-docs.deepseek.com/)
- [Code Llama 34B Dokumentasi](https://llama.meta.com/docs/)
