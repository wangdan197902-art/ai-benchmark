...
| Benchmark | Gemini 1.5 Flash | Llama 3.1 8B | Pemenang |
|------|------|------|--------|
| ARC | 93.4 | 87.4 | A |
...
- [Gemini 1.5 Flash Dokumentasi](https://ai.google.dev/gemini-api/docs)
- [Llama 3.1 8B Dokumentasi](https://llama.meta.com/docs/)
