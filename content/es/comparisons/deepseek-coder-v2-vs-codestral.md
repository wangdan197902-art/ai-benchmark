...
# DeepSeek Coder V2 contra Codestral
...
| Benchmark | DeepSeek Coder V2 | Codestral | Ganador |
|------|------|------|--------|
| ARC | 88.5 | 87.4 | A |
...
- [DeepSeek Coder V2 Documentación](https://api-docs.deepseek.com/)
- [Codestral Documentación](https://docs.mistral.ai/)
