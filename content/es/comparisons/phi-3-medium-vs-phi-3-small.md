...
# Phi-3 Medium contra Phi-3 Small
...
| Benchmark | Phi-3 Medium | Phi-3 Small | Ganador |
|------|------|------|--------|
| ARC | 90.1 | 89.6 | A |
...
- [Phi-3 Medium Documentación](https://huggingface.co/models)
- [Phi-3 Small Documentación](https://huggingface.co/models)
