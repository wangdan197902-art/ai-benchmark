---
title: "Gemini 1.5 Pro vs Gemini 2.0 Flash：基准对比"
description: "详细对比 Gemini 1.5 Pro 与 Gemini 2.0 Flash 的基准表现、定价、上下文窗口与合规性。"
date: 2024-02-15
lastmod: 2024-02-15
draft: false
weight: 10
...
# Gemini 1.5 Pro 对比 Gemini 2.0 Flash

## 模型概述

Gemini 1.5 Pro 与 Gemini 2.0 Flash 均为 AI 模型市场的重要选项。本页对比两者在基准、定价与合规性上的差异。
...
| 基准 | Gemini 1.5 Pro | Gemini 2.0 Flash | 胜出 |
|------|------|------|--------|
| ARC | — | 95.7 | B |
...
Gemini 1.5 Pro 与 Gemini 2.0 Flash 各有侧重。建议根据具体场景（代码、长文本、视觉等）选择，参考上方基准与定价表。
