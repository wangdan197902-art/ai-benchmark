---
title: "Claude 3.5 Haiku vs Gemini 1.5 Flash：基准对比"
description: "详细对比 Claude 3.5 Haiku 与 Gemini 1.5 Flash 的基准表现、定价、上下文窗口与合规性。"
date: 2024-11-04
lastmod: 2024-11-04
draft: false
weight: 10
...
# Claude 3.5 Haiku 对比 Gemini 1.5 Flash

## 模型概述

Claude 3.5 Haiku 与 Gemini 1.5 Flash 均为 AI 模型市场的重要选项。本页对比两者在基准、定价与合规性上的差异。
...
| 基准 | Claude 3.5 Haiku | Gemini 1.5 Flash | 胜出 |
|------|------|------|--------|
| ARC | 91.8 | 93.4 | B |
...
Claude 3.5 Haiku 与 Gemini 1.5 Flash 各有侧重。建议根据具体场景（代码、长文本、视觉等）选择，参考上方基准与定价表。
