...
| Бенчмарк | GPT-4 | GPT-4 Turbo | Победитель |
|------|------|------|--------|
| ARC | 94.1 | 94.2 | Tie |
...
- [GPT-4 Документация](https://platform.openai.com/docs/models)
- [GPT-4 Turbo Документация](https://platform.openai.com/docs/models)
