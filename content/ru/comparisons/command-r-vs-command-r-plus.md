...
| Бенчмарк | Command R | Command R+ | Победитель |
|------|------|------|--------|
| ARC | 93.9 | — | A |
...
- [Command R Документация](https://docs.cohere.com/docs)
- [Command R+ Документация](https://docs.cohere.com/docs/command-r-plus)
