...
# NVIDIA Llama 3.1 Nemotron 70B против Llama 3.1 70B
...
| Бенчмарк | NVIDIA Llama 3.1 Nemotron 70B | Llama 3.1 70B | Победитель |
|------|------|------|--------|
| ARC | 93.2 | 92.3 | A |
...
- [NVIDIA Llama 3.1 Nemotron 70B Документация](https://huggingface.co/models)
