...
# Hermes 3 Llama 3.1 405B gegen Llama 3.1 405B
...
| Benchmark | Hermes 3 Llama 3.1 405B | Llama 3.1 405B | Gewinner |
|------|------|------|--------|
| ARC | 94.5 | — | A |
...
- [Hermes 3 Llama 3.1 405B Dokumentation](https://huggingface.co/models)
