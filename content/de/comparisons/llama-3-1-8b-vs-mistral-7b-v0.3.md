...
# Llama 3.1 8B gegen Mistral 7B v0.3
...
| Benchmark | Llama 3.1 8B | Mistral 7B v0.3 | Gewinner |
|------|------|------|--------|
| ARC | 87.4 | 88.9 | B |
...
- [Llama 3.1 8B Dokumentation](https://llama.meta.com/docs/)
- [Mistral 7B v0.3 Dokumentation](https://docs.mistral.ai/)
