...
# Llama 3.1 70B gegen DeepSeek V2
...
| Benchmark | Llama 3.1 70B | DeepSeek V2 | Gewinner |
|------|------|------|--------|
| ARC | 92.3 | 92.1 | Tie |
...
- [Llama 3.1 70B Dokumentation](https://llama.meta.com/docs/)
- [DeepSeek V2 Dokumentation](https://api-docs.deepseek.com/)
