...
# Claude 3.5 Sonnet gegen Claude 3 Opus
...
| Benchmark | Claude 3.5 Sonnet | Claude 3 Opus | Gewinner |
|------|------|------|--------|
| ARC | — | 94.5 | B |
...
- [Claude 3 Opus Dokumentation](https://docs.anthropic.com/claude/docs)
