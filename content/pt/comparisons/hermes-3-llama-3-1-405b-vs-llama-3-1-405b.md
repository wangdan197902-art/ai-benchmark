...
# Hermes 3 Llama 3.1 405B contra Llama 3.1 405B
...
| Benchmark | Hermes 3 Llama 3.1 405B | Llama 3.1 405B | Vencedor |
|------|------|------|--------|
| ARC | 94.5 | — | A |
...
- [Hermes 3 Llama 3.1 405B Documentação](https://huggingface.co/models)
