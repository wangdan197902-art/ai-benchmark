...
| Benchmark | GPT-4 | GPT-4 Turbo | Vincitore |
|------|------|------|--------|
| ARC | 94.1 | 94.2 | Tie |
...
- [GPT-4 Documentazione](https://platform.openai.com/docs/models)
- [GPT-4 Turbo Documentazione](https://platform.openai.com/docs/models)
