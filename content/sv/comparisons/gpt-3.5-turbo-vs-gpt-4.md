...
| Benchmark | GPT-3.5 Turbo | GPT-4 | Vinnare |
|------|------|------|--------|
| ARC | 86.8 | 94.1 | B |
...
- [GPT-3.5 Turbo Dokumentation](https://platform.openai.com/docs/models)
- [GPT-4 Dokumentation](https://platform.openai.com/docs/models)
