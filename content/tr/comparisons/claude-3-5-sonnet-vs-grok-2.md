...
# Claude 3.5 Sonnet karşı Grok-2
...
| Benchmark | Claude 3.5 Sonnet | Grok-2 | Kazanan |
|------|------|------|--------|
...
- [Claude 3.5 Sonnet Dokümantasyon](https://docs.anthropic.com/claude/docs)
- [Grok-2 Dokümantasyon](https://docs.x.ai/)
