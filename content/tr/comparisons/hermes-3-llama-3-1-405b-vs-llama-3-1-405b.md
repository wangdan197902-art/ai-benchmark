...
# Hermes 3 Llama 3.1 405B karşı Llama 3.1 405B
...
| Benchmark | Hermes 3 Llama 3.1 405B | Llama 3.1 405B | Kazanan |
|------|------|------|--------|
| ARC | 94.5 | — | A |
...
- [Hermes 3 Llama 3.1 405B Dokümantasyon](https://huggingface.co/models)
