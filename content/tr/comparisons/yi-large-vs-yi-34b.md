...
| Benchmark | Yi Large | Yi 34B | Kazanan |
|------|------|------|--------|
| ARC | 94.8 | 87.2 | A |
...
- [Yi Large Dokümantasyon](https://huggingface.co/models)
- [Yi 34B Dokümantasyon](https://huggingface.co/models)
