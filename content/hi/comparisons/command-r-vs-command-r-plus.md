...
| बेंचमार्क | Command R | Command R+ | विजेता |
|------|------|------|--------|
| ARC | 93.9 | — | A |
...
- [Command R दस्तावेज़ीकरण](https://docs.cohere.com/docs)
- [Command R+ दस्तावेज़ीकरण](https://docs.cohere.com/docs/command-r-plus)
