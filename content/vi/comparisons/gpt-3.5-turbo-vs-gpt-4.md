...
| Benchmark | GPT-3.5 Turbo | GPT-4 | Người chiến thắng |
|------|------|------|--------|
| ARC | 86.8 | 94.1 | B |
...
- [GPT-3.5 Turbo Tài liệu](https://platform.openai.com/docs/models)
- [GPT-4 Tài liệu](https://platform.openai.com/docs/models)
