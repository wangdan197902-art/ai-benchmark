...
| Benchmark | Claude 2.1 | Claude 2 | Người chiến thắng |
|------|------|------|--------|
| ARC | 84.8 | 80.4 | A |
...
- [Claude 2.1 Tài liệu](https://docs.anthropic.com/claude/docs)
- [Claude 2 Tài liệu](https://docs.anthropic.com/claude/docs)
