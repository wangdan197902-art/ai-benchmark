...
| Benchmark | Phi-3 Medium | Phi-3 Small | Người chiến thắng |
|------|------|------|--------|
| ARC | 90.1 | 89.6 | A |
...
- [Phi-3 Medium Tài liệu](https://huggingface.co/models)
- [Phi-3 Small Tài liệu](https://huggingface.co/models)
