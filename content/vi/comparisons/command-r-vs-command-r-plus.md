...
| Benchmark | Command R | Command R+ | Người chiến thắng |
|------|------|------|--------|
| ARC | 93.9 | — | A |
...
- [Command R Tài liệu](https://docs.cohere.com/docs)
- [Command R+ Tài liệu](https://docs.cohere.com/docs/command-r-plus)
