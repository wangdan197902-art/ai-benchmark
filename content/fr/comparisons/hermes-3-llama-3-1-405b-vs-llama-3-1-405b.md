...
# Hermes 3 Llama 3.1 405B contre Llama 3.1 405B
...
| Benchmark | Hermes 3 Llama 3.1 405B | Llama 3.1 405B | Gagnant |
|------|------|------|--------|
| ARC | 94.5 | — | A |
...
- [Hermes 3 Llama 3.1 405B Documentation](https://huggingface.co/models)
